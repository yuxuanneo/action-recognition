...
def parse_args(config_path):
    ...
    parser.add_argument(
        '--checkpoint',
        default=config_args['checkpoint'],
        help='spatio temporal detection checkpoint file/url')
    parser.add_argument(
        '--det-config',
        default=config_args['det-config'],
        help='human detection config file path (from mmdet)')
    parser.add_argument(
        '--det-checkpoint',
        default=config_args['det-checkpoint'],
        help='human detection checkpoint file/url')
    parser.add_argument(
        '--det-score-thr',
        type=float,
        default=config_args['det-score-thr'],
        help='the threshold of human detection score')
    parser.add_argument(
        '--action-score-thr',
        type=float,
        default=config_args['action-score-thr'],
        help='the threshold of human action score')
    parser.add_argument(
        '--video', 
        default = config_args['video'], 
        help='video file/url')
    parser.add_argument(
        '--label-map',
        default=config_args['label-map'],
        help='label map file')
    parser.add_argument(
    ...
    parser.add_argument(
        '--predict-stepsize',
        default=config_args['predict-stepsize'],
        type=int,
        help='give out a prediction per n frames')
    parser.add_argument(
        '--output-stepsize',
        default=config_args['output-stepsize'],
        type=int,
        help=('show one frame per n frames in the demo, we should have: '
              'predict_stepsize % output_stepsize == 0'))
    parser.add_argument(
        '--output-fps',
        default=config_args['output-fps'],
        type=int,
